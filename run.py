...
def get_sales_data():
    """
    Get sales figures input from the user. Run a while loop to 
    collect a valid string of data from the user via the 
    terminal, which must be a string of 6 numbers separated by 
...
def validate_data(values):
    ...
    Raises Value if strings cannot be converted into int,
...
def calculate_stock_data(data):
    """
    Calculate the average stock for each market day
    """
